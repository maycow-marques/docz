...
function EmailAction() {
  ...
  return (
    ...
    >
      <span className="bg-primary-100 grid h-12 w-12 place-content-center rounded-full text-xl text-white">
        <Icon name="PiEnvelopeSimpleDuotone" size={28} />
      </span>
      <span>
        <strong className="block text-lg leading-4 font-medium">Email</strong>
        <small>{t("navigation.contacts.email")}</small>
      </span>
    </Link>
  );
}
...
function PhoneAction() {
  ...
  return (
    <Link href="tel:08005911478" target="_blank" className="flex items-center gap-3">
      <span className="bg-primary-100 grid h-12 w-12 place-content-center rounded-full text-xl text-white">
        <Icon name="PiPhoneCallDuotone" size={28} />
      </span>
      <span>
        <strong className="block text-lg leading-4 font-medium">Phone</strong>
        <small>{t("navigation.contacts.phone")}</small>
      </span>
    </Link>
  );
}
...
function BitrixAction() {
  ...
  return (
    ...
    >
      ...
      <span>
        <strong className="block text-lg leading-4 font-medium">Bitrix</strong>
        <small>{t("navigation.contacts.bitrix")}</small>
      </span>
    </Link>
  );
}
  ...
  return (
    ...
    >
      <span className="grid h-12 w-12 place-content-center rounded-full bg-green-500 text-xl text-white">
        <Icon name="PiWhatsappLogoDuotone" size={28} />
      </span>
      <span>
        <strong className="block text-lg leading-4 font-medium">Whatsapp</strong>
        <small>{t("navigation.contacts.whatsapp")}</small>
      </span>
    </Link>
  );
}
